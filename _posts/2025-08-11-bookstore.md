...
I often hear my wife exclaim, "_Oh how wonderful would it be to run my own little bookstore once I retire!_". I frown. A small, local business. I have nothing against them. If anything, I am the largest proponent of small, local businesses. I generally refuse to eat at VC and PE funded bagel joints (but once in a while, I am forced to give in and get a cleverly priced 3 bagel serving from Pop Up at my wife's behest). If there is a local business alternative to a PE funded one, I will pick the local one 9 out of 10 times. That's why Blank Street, and it's beautifully optimized operations see very few of my dollars, whereas Hutch and Waldo, of the Upper East Side sees them. Although, I have to caveat, I almost never buy my coffee outside. I am learning how to create latte art. Which is wholly unrelated to the disucssion at hand around bookstores. 

I frown at the idea of running a local business. The real reason I support these businesses is not just because I want them to thrive. I support them because I know running one is a truly borderline foolish endeavour in a large majority of cases. And in my books, running a bookstore is the worst offender. And I wanted to explain to my wife why just running a bookstore is asking for trouble. I believe we have already seen the last bookstore in the upper east. Let me explain.

## The last bookstore in the Upper East has been built.

I live in the Upper East, so I took that as an example. I never understood how you could run a bookstore here. It never passed the sniff test. There is a large Barnes & Nobles here, but I am going to leave it out from this conversation, since those stores function on completely different economic and business incentives. This Barnes & Nobles also happens to tbe the newest bookstore in the neighbourhood. Too bad for the others. Here is a best effort list of bookstores in the Upper East.
...
<div style="text-align: center;">
  <em>Data maybe incorrect, but that's beside the point</em>
</div>
...
What do you notice? No real bookstore has been opened since 1983. The ones from 2000s are not real bookstores. Assouline is obviously some kind of a money laundering front for the rich. Albertine is an attempt at using the French Embassy's real estate to increase their cultural soft power (maybe they can learn from the Koreans). And Barnes & Nobles is Barnes & Nobles
...
<figure style="text-align: center;">
  ...
  <figcaption style="font-style: italic;">Barnes &amp; Nobles is Barnes &amp; Nobles</figcaption>
</figure>


Now, I wanted to explain to my wife, starting a bookstore is a bad idea. 
...
I have to say – I love ChatGPT because of this kind of stuff. The breadth of the world's knowledge in tokens, all for me to enjoy. I didn't think I'd love playing with AOV and OpEx values for a bookstore nearly as much as I did. The coversation was long. GPT thought for 4 mins and 14 seconds before uttering a word. And then it unleashed wisdom, in spades. Here is an abridged version.

Chatty suggested two routes, one is the "lean" approach, and the other one is the "prime" approach. 
...
Before we move one, we need to prepare a bit for the fun part, the unfortunate business jargon. 
...
Startup costs are a very real thing, especially the security deposit, buying your initial book inventory and build out of course. I know my wife would do a fabulous job in making the book the perfect cozy bookstore, but it's going to cost a pretty penny. 

Let's go back to the two cases, lean and prime. 

| Line item                                     | PRIME — 3rd Ave (1,200 sf) | LEAN — First/York (1,000 sf) | Notes                                                      |
| --------------------------------------------- | -------------------------: | ---------------------------: | ---------------------------------------------------------- |
...
Even if we assume Chatty is being a bit to lose with the budget, that'd be a bare minimum of a quarter million dollar startup cost for even the super lean bookstore on 1st and York. 
...
At a 40% contribution margin (scroll back up if you missed that), you’d need $105,000 in sales each month just to break even. That’s about $3,500 in sales every single day. If the average order value is $30, that means roughly 117 transactions a day—every day, no off days. Just to avoid _losing_ money.
...
A First or York Avenue space trades prime visibility for breathing room on costs. Rent runs about $8,300 a month, and there’s no CRT to worry about. With payroll and other overhead, the fixed monthly cost is closer to $23,500. Of course, this also means lesser footfall. Further from the subway. I barely ever go to York, unless it's to go play pickleball. 

Here, break-even sits around $59,000 in sales per month, or about $2,000 a day. At $30 AOV, that’s roughly 66 transactions per day.
...
People often discount the lifestyle in running a business. I asked Chatty to help me paint a picture here. 

Figures are **monthly**, before owner pay, debt service, and taxes. Assumptions are conservative: average ticket about **\$30**; card fees roughly **3.1%**; gross margin posture varies by execution—**38%** (“books-only/bad”), **43%** (“disciplined/okay”), **46%** (“well-run/excellent”). Contribution margin is gross margin minus card fees.
...
Clearly, even with stellar execuation, this is not a business you enter for the money. In the median case you are going to be barely making a living wage. 


## Would I start a bookstore?

Yes. I would. I love a good challenge. You may have noticed that everywhere in this essay, I stressed on the _just_ a bookstore aspect.
